...
import { CloneTree } from "../diploma-in-pharmacy-react/_components/CloneTree";
import { TabsActivator } from "../diploma-in-pharmacy-react/_components/TabsActivator";

export const metadata: Metadata = { title: "D.Pharm" };
